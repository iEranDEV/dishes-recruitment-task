...
import DishTypeOption from "./DishTypeOption";
...
export default function DishTypeSelect({ register, setValue, error, clearErrors }: DishTypeSectionProps) {
    ...
    return (
        <>
            ...
            <DishTypeOption img={pizzaImage} type={DishType.Pizza} selectType={selectType} selected={typeRef.current?.value === 'pizza'} />
            <DishTypeOption img={soupImage} type={DishType.Soup} selectType={selectType} selected={typeRef.current?.value === 'soup'} />
            <DishTypeOption img={sandwichImage} type={DishType.Sandwich} selectType={selectType} selected={typeRef.current?.value === 'sandwich'} />
            </div>
